...
|---------|----------|-----------------|
| **Part 1: Descriptive Statistics** | 55 min | `.info()`, `.describe()`, `.value_counts()`; summarising data |
| **Part 2: Data Quality** | 55 min | Missing values; duplicates; outliers; cleaning strategies |
| **Part 3: Data Transformation** | 55 min | String & categorical operations; file I/O; regex basics |
...
| [Post-Class](./post-class.md) | EDA practice challenges — clean and analyse a messy dataset | 45–60 min |
